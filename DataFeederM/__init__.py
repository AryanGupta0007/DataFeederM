...
class _DataFeedModule:
    def __call__(self, ORB_URL=None, ORB_PASSWORD=None, ORB_USERNAME=None, epochs=None, syms=None):
        ...
        return main(ORB_URL=ORB_URL, ORB_PASSWORD=ORB_PASSWORD, ORB_USERNAME=ORB_USERNAME, epochs=epochs, syms=syms)
